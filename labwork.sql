create table employee(emp_id int,first_name varchar(50),last_name varchar(50),birth_date date,sex varchar(10),salary varchar(50),super_id varchar(50),branch_id int,primary key(emp_id),foreign key (super_id,branch_id) references branch(branch_id));
...
create table client(client_id int,client_name varchar(50),branch_id int,primary key(client_id),foreign key (branch_id) references branch(branch_id));
...
create table branch_supplier(branch_id int,supplier_name varchar(50),supply_type varchar(50),foreign key (branch_id) references branch(branch_id));
